...
<div class="container2 column-gap-md-2">
  ...
  <div class="section5 d-flex">
    ...
    <div class="card mt-5 border border-2 m-1" style="width: 90rem;">
      <img src="asset/photos/viennoiserie/croissantBeurre3.jpg" class="card-img-top" alt="...">
      <div class="card-body bg-secondary">
        <p class="card-text text-center">Croissant au Beurre</p>
      </div>
    </div>
    ...
    <div id="carouselExampleCaptions2" class="carousel slide mt-5">
      ...
      <div class="carousel-inner">
        ...
        <div class="carousel-item">
          <img src="asset/photos/viennoiserie/croissantBeurre.jpg" class="d-block w-100" alt="...">
          <div class="carousel-caption d-md-block form-select-lg sticky-top col-3 container">
        ...
        <div class="carousel-item">
          <img src="asset/photos/viennoiserie/painAuChocolat.jpg" class="d-block w-100" alt="...">
          <div class="carousel-caption d-md-block form-select-lg sticky-top col-3 container">
            <h5>Pain au chocolat</h5>
          </div>
        </div>
        <div class="carousel-item">
          <img src="asset/photos/viennoiserie/painAuChocolat2.jpg" class="d-block w-100" alt="...">
          <div class="carousel-caption d-md-block form-select-lg sticky-top col-3 container">
            <h5>Pain au chocolat</h5>
          </div>
        </div>
        <div class="carousel-item">
          <img src="asset/photos/viennoiserie/croissantOrdinaire.jpg" class="d-block w-100" alt="...">
          <div class="carousel-caption d-md-block form-select-lg sticky-top col-3 container">
        ...
        <div class="carousel-item">
          <img src="asset/photos/viennoiserie/painAuxRaisins.jpg" class="d-block w-100" alt="...">
          <div class="carousel-caption d-md-block form-select-lg sticky-top col-3 container">
            <h5>Pain aux raisins</h5>
          </div>
        </div>
        <div class="carousel-item">
          <img src="asset/photos/viennoiserie/painAuxRaisins2.jpg" class="d-block w-100" alt="...">
          <div class="carousel-caption d-md-block form-select-lg sticky-top col-3 container">
            <h5>Pain aux raisins</h5>
          </div>
        </div>
        <div class="carousel-item">
          <img src="asset/photos/viennoiserie/pepiteChocolat.jpg" class="d-block w-100" alt="...">
          <div class="carousel-caption d-md-block form-select-lg sticky-top col-3 container">
            <h5>Pépite chocolat</h5>
          </div>
        </div>
        <div class="carousel-item">
          <img src="asset/photos/viennoiserie/escargotPistChoc.jpg" class="d-block w-100" alt="...">
          <div class="carousel-caption d-md-block form-select-lg sticky-top col-3 container">
            <h5>Escargot pistache chocolat</h5>
          </div>
        </div>
        <div class="carousel-item">
          <img src="asset/photos/viennoiserie/briocheSucre.jpg" class="d-block w-100" alt="...">
          <div class="carousel-caption d-md-block form-select-lg sticky-top col-3 container">
        ...
        <div class="carousel-item">
          <img src="asset/photos/viennoiserie/croissantAmande.jpg" class="d-block w-100" alt="...">
          <div class="carousel-caption d-md-block form-select-lg sticky-top col-3 container">
            <h5>Croissant aux amandes</h5>
          </div>
        </div>
        <div class="carousel-item">
          <img src="asset/photos/viennoiserie/chocoAmande.jpg" class="d-block w-100" alt="...">
          <div class="carousel-caption d-md-block form-select-lg sticky-top col-3 container">
