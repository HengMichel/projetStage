...
<<<<<<< HEAD
      <img src="asset/photos/newNight2.jpg" class="d-block w-75" alt="..." />
    </div>
    <div class="carousel-item">
      <img src="asset/photos/newDay2.jpg" class="d-block w-75" alt="..." />
=======
<<<<<<< Updated upstream
      <img src="asset/photos/newNight2.jpg" class="d-block w-100" alt="..." />
    </div>
    <div class="carousel-item">
      <img src="asset/photos/newDay2.jpg" class="d-block w-100" alt="..." />
=======
      <img src="asset/photos/newNight2.jpg" class="d-block w-75" alt="..." />
    </div>
    <div class="carousel-item">
...
<div class="container"> 
  <div class="blocM">
    <div class="card border-dark border-2 mb-3 mt-3 container" style="max-width: 25rem;">
    ...
    <div class="accordion container mt-3" style="max-width: 26rem;" id="accordionExample">
      <div class="accordion-item border border-2 bg-light">
    ...
    <div class="accordion-item border border border-2 bg-light">
    ...
    <div class="card border-dark border-2 mb-3 mt-5 container" style="max-width: 25rem;">
        <div class="card-header">
...
<div class="card border-dark border-2 mb-3 mt-2" style="max-width: 90rem;">
